...
### #92: eBay takedown
End the 640 archived-watch eBay listings without touching the 155 keeper SKUs. **Do not use Marketplace Connect** (uninstalled 2026-09-18). End in eBay Seller Hub; in M2E stop sync / unlink those SKUs so they are not relisted. Handoff `docs/handoffs/92-astra-ebay-takedown.md` still has the SKU lists; ignore its Connect bulk-disable URL.
